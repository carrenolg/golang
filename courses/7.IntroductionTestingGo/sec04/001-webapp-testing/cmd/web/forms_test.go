...
func Test_forms_has(t *testing.T) {
	form := NewForm(nil)
...
func Test_forms_required(t *testing.T) {
...
func Test_forms_check(t *testing.T) {
	form := NewForm(nil)
...
func Test_forms_get(t *testing.T) {
	postedData := url.Values{}
	postedData.Add("user", "user")
	form := NewForm(postedData)
	form.Check(false, "password", "password is required")
	// get
